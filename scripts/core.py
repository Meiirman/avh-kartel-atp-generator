...
def run_project(*args, **kwargs) -> None:
    ...
    # 1. Генерировать АТП
    button_generate1 = tk.Button(root, text="Генерировать АТП", command=lambda: generate("atp", project))
    ...
    entry_folder4 = tk.Entry(root, textvariable=folder4_var, state="normal" , width=30)
